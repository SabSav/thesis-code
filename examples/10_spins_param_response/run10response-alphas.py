...
cases = [
    ...
    {'method': mc, 'label': 'Response MC',
     ...
     'burn_in': 40, 'length': np.array([10, 50]), 'frame_step': np.array([1, 1]),
     'output': f'{dir_path}/mc-response.json'},
    {'method': alg1, 'label': 'Response Alg1',
     'size': size, 'temperature': np.array([lT, hT]), 'field': h, 'coupling': J,
     'action_rates': action_rates0, 'dt': np.array([1e-3, 1e-3]),
     'burn_in': 250000, 'length': np.array([10**4, 5*10**4]), 'frame_step': np.array([10**3, 10**3]),
    ...
    {'method': alg2, 'label': 'Response Alg2',
     ...
     'burn_in': 250, 'length': np.array([10, 50]), 'frame_step': np.array([1, 1]),
     'output': f'{dir_path}/a2-response-alphas={action_rates0[0,0]},{action_rates0[1,0]}.json'},
    {'method': alg1, 'label': 'Response Alg1',
     'size': size, 'temperature': np.array([lT, hT]), 'field': h, 'coupling': J,
     'action_rates': action_rates1, 'dt': np.array([1e-3, 1e-3]),
     'burn_in': 250000, 'length': np.array([10**4, 5*10**4]), 'frame_step': np.array([10**3, 10**3]),
    ...
    {'method': alg1, 'label': 'Response Alg1',
     'size': size, 'temperature': np.array([lT, hT]), 'field': h, 'coupling': J,
     'action_rates': action_rates2, 'dt': np.array([1e-3, 1e-3]),
     'burn_in': 250000, 'length': np.array([10**4, 5*10**4]), 'frame_step': np.array([10**3, 10**3]),
