...
def case():
    ...
    mc(Arguments({
        'size': size, 'temperature': lT, 'field': h, 'coupling': J, 'burn_in': 10, 'length': length_lT,
        'seed': seed, 'frame_step': frame_step_lT,
        'output': f'{file_path}/mc-lT_' + date_string + '.json'  # low T mc
    }))

    mc(Arguments({
        'size': size, 'temperature': hT, 'field': h, 'coupling': J, 'burn_in': 10, 'length': length_hT,
        'seed': seed, 'frame_step': frame_step_hT,
    ...
    alg1(Arguments({
        ...
        'length': length_lT, 'seed': seed, 'frame_step': frame_step_lT,
    ...
    alg1(Arguments({
        ...
        'length': length_hT, 'seed': seed, 'frame_step': frame_step_hT,
