...
# RB: The date can be written into the output file or it should be hard-coded
date_string = datetime.date.today().strftime("%Y-%m-%d")

def case_lt_with_correlations():
...
#     #     burn_in=4000, length=100000, frame_step=1,
#     #     output=f'{dir_path}/mc-hT.json'  # high T mc
#     # )
#     alg1(
#         size=size, temperature=lT, field=h, coupling=J,
#         action_rates=action_rates,
...
if __name__ == '__main__':
    case_lt_with_correlations()
    # case_without_correlations()
